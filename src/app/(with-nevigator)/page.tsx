    ...
    <div>
      ...
      <div className={style.middle_content}>
        ...
        <div className={style.board}>
          <p>게시판 최신 댓글</p>
          {board.board.slice(0, 5).map((item, i) => (
      ...
      <div className={style.youtube_content}>
        <div className={style.youtube}>
          <div>
            ...
            ></iframe>
            <p>
              데이브 더 다이버 - Xbox 런칭 트레일러 + 인 더 정글 DLC 티징 공개 |
              지금 바로 만나보세요!
            </p>
          </div>
          <div>
            ...
            ></iframe>
            <p>
              [Playlist] 흰동가리초밥이 먹고 싶어지는 음악 🍣 | 데이브 더 다이버
            </p>
          </div>
          <div>
            <iframe
              ...
              allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
            ></iframe>
            <p>데이브 더 다이버 2주년 감사 인사 + 신규 정보 대공개!</p>
          </div>
          <div>
            <iframe
              width={280}
            ...
            ></iframe>
            <p>
              DEV DIVE | FRIENDS 콜라보레이션! 그리고 개선사항을 안내드립니다! -
              10월 업데이트 예정
            </p>
          </div>
        </div>
